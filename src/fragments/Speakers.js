  ...
  render() {
    ...
    return (
      <div className="tc">
          ...
          .map(speaker => {
            return (
              <div className="mb5">
                ...
                <a href={speaker.twitter} className="green4 dib h2 w2 br-100 pa2 bg-white mr2">
                ...
                <a href={speaker.url} className="green4 dib h2 w2 br-100 pa2 bg-white ml2">
        ...
        <p className="eau-bold ttu blue1 f3">
          Got something cool to share?
        </p>
        <a href="" className="bg-blue1 dib white pa3 no-underline open-sans center">
          Be a speaker
        </a>
      </div>);
  }
